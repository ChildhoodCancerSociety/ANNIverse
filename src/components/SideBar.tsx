    ...
    return(
        ...
        <div className="sideBarTop flex flex-col justify-between h-60">
          <div className="whiteBoard relative">
            <div className="whiteBoardSvg border-2 border-neutral-400 h-7 w-12 rounded-sm hover:cursor-pointer hover:scale-110 hover:border-neutral-700 transition-all"></div>
            <h1 className="absolute bottom-0 left-14 text-neutral-50 bg-neutral-700 p-1 rounded-sm opacity-0">Whiteboard</h1>
          </div>
          ...
          <div className="tasks text-neutral-500 hover:cursor-pointer hover:scale-110 hover:text-neutral-700 transition-all flex justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-list-task" viewBox="0 0 16 16">
          ...
          <div className="alarm text-neutral-500 hover:cursor-pointer hover:scale-110 hover:text-neutral-700 transition-all flex justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-alarm-fill" viewBox="0 0 16 16">
