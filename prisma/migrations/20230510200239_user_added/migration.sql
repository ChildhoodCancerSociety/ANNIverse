-- CreateEnum
CREATE TYPE "Role" AS ENUM ('PM', 'SoftwareDev', 'Admin', 'Volunteer');
...
CREATE TABLE "TeamMeeting" (
    ...
    CONSTRAINT "TeamMeeting_pkey" PRIMARY KEY ("meetingId","teamId")
);
...
-- AddForeignKey
ALTER TABLE "TeamMeeting" ADD CONSTRAINT "TeamMeeting_meetingId_fkey" FOREIGN KEY ("meetingId") REFERENCES "Meeting"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TeamMeeting" ADD CONSTRAINT "TeamMeeting_teamId_fkey" FOREIGN KEY ("teamId") REFERENCES "Team"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
